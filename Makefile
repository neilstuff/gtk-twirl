...
SRC = handler.c writer.c reader.c geometry.c drawer.c editor.c artifact.c event.c vertex.c node.c arc.c connector.c mover.c selector.c net.c controller.c main.c
